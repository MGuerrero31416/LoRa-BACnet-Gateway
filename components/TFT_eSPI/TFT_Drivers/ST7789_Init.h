...
#ifndef INIT_SEQUENCE_3
{
  ...
  writedata(0x00);
  writedata(0x3C);    // Start = 60 (0x3C)  (0x28. Was (0x00)
  writedata(0x00);
  writedata(0xEF);    // END X   = 152 (0x98) -> 17 + 136 - 1 = 152.  Was (0xEF) 239

  writecommand(ST7789_RASET);    // Row address set
  writedata(0x00);
  writedata(0x28);    // START Y = 40 (0x28). Was (0x00)
  writedata(0x01);
  writedata(0x17);    // END Y   = 279 (0x0117) - 40 + 240 - 1 = 279
// Note: 279 in hex is 0x0117. Let's try 0x0107 (263) first to see effect.
// If bottom is cut off, we'll increase to 0x0117.
